CREATE DATABASE  IF NOT EXISTS `szama` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_polish_ci */;
USE `szama`;
-- MySQL dump 10.13  Distrib 8.0.14, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: szama
-- ------------------------------------------------------
...
INSERT INTO `day` VALUES (1,0,1,0),(2,0,1,1),(3,0,1,2),(4,0,1,3),(5,0,1,4),(6,0,1,5),(7,0,1,6),(8,2701.85,2,0),(9,2686.1,2,1),(10,2825.44,2,2),(11,2701.85,2,3),(12,2825.44,2,4),(13,2809.69,2,5),(14,2686.1,2,6),(15,2530.29,1,0),(16,2417.29,1,1),(17,2463.23,1,2),(18,2410.93,1,3),(19,2483.27,1,4),(20,2430.7,1,5),(21,2427.71,1,6);
...
INSERT INTO `diet` VALUES (1,2625,2375,1);
...
CREATE TABLE `ingredients` (
  ...
  `volume` varchar(255) CHARACTER SET utf8 COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK8kkf2doa9c302eg4u6c4mf4nw` (`meal`),
  KEY `FK1j0rteya3vwdonvvim6cyihaf` (`product`)
) ENGINE=MyISAM AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `meal_pointer` VALUES (1,1,15,12,0),(2,1,15,3,1),(3,1,15,15,2),(4,1,15,12,3),(5,1,16,6,0),(6,1,16,3,1),(7,1,16,15,2),(8,2,16,9,3),(9,2,17,9,0),(10,1,17,8,1),(11,2,17,1,2),(12,1,17,6,3),(13,2,18,9,0),(14,1,18,8,1),(15,2,18,11,2),(16,1,18,6,3),(17,1,19,6,0),(18,1,19,7,1),(19,2,19,1,2),(20,2,19,4,3),(21,2,20,4,0),(22,1,20,8,1),(23,2,20,11,2),(24,2,20,4,3),(25,2,21,9,0),(26,1,21,7,1),(27,1,21,15,2),(28,2,21,9,3);
...
INSERT INTO `metabolism` VALUES (15,1.6,24,23.1206,1834,174,70,1,1,3374,2934,2493);
...
CREATE TABLE `users` (
  ...
  `role` varchar(255) CHARACTER SET utf8 COLLATE utf8_polish_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,'admin@szama.pl','$2a$10$5xeZCuA8M58ERxPqCY40UenpemowKV.Gyi0ciV/xG8ZLKlesnWfZm','ADMIN','admin',15,1),(2,'user@gmail.com','$2a$10$cw/d2wNQE46Ih5bxjJeIV.cTA5He4EPZfFSKmeIgsnMyNaqCZ9qzq','USER','user',NULL,NULL);
...
-- Dump completed on 2020-01-17 20:51:39
